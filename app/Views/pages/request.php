...
<section class="pt-2 mb-4">
	...
	<div class="alert bg-info bg-opacity-10 text-info " role="alert">
		...
		<p>Our website is a public directory connecting users with drivers. Your email and phone number will only be used for direct driver communication,
			...
			<div class="col-md-6">
				<div class="card shadow pb-0">
					...
					<div class="card-header border-bottom p-3 p-sm-4">
						<h5 class="card-title mb-0">Let's find some rides for you!</h5>
					</div>

					<!-- Card body START -->
					<form class="card-body form-control-border p-3 p-sm-4" id="request">
					 <input type="hidden" value="2" id="type">
								...
								<div class="row g-2 g-md-4">
									...
									<div class="col-md-6 position-relative">
										...
										<div class="btn-flip-icon z-index-9 mt-2 mt-md-1">
											<a href="#" class="btn btn-dark shadow btn-round mb-0"><i class="fa-solid fa-right-left"></i></a>
										</div>
									</div>
									...
									<div class="col-md-6">
										<div class="form-fs-lg form-control-transparent">
											...
											<input id="date-input" type="text" class="form-control flatpickr  form-control-lg"  data-date-format="Y-m-d" placeholder="Select date">
										</div>
									</div>
									...
									<div class="col-md-6 text-md-end">
										<div class="form-fs-lg form-control-transparent">
											...
											<input id="time-input" type="text" class="form-control flatpickr text-md-end  form-control-lg" data-enableTime="true" data-noCalendar="true" placeholder="Select time">
										</div>
									</div>
									...
									<div class="col-md-6">
										<div class="form-fs-lg form-control-transparent">
											<label class="form-label small">Seats Required</label>
											<input id="available-seats-input" type="number" min="1" max="10" class="form-control form-control-lg" placeholder="Enter your required seats">
										</div>
									</div>
									...
									<div class="col-md-6">
										<div class="form-fs-lg form-control-transparent">
											...
											<small class="from-text">Verification email will be send on this address.</small>
										</div>
									</div>
									...
									<div class="col-md-6">
										<div class="form-fs-lg form-control-transparent">
											...
											<small class="from-text">This will help drivers to contact you ASAP.</small>
										</div>
									</div>
									...
									<div class="col-md-12">
										<div class="form-fs-lg form-control-transparent">
											<label class="form-label small ms-3 ms-md-0 me-md-3">Note (Optional)</label>
											<textarea id="description-input" class="form-control form-control-lg" placeholder="Add any details relevant to your trip for driver before they assign to you?"></textarea>
										</div>
									</div>
						...
						<div class="d-grid mt-3">
							<button type="submit" id="request-button" class="btn btn-success mb-0">Post Request</button>
						</div>
